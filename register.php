...
$fnameError = $lnameError = $emailError = $phnError = $addrError = $passError = $picError = '';
...
if (isset($_POST['btn-signup'])) {
    ...
    if (!$error) {
        ...
        $query = "INSERT INTO users(first_name, last_name, email, phone_number, address, picture, password, status)
                  VALUES('$fname', '$lname', '$email', '$phone_number', '$address', '$picture->fileName', '$password', 'user')";
...
<body>
    <div class="container d-flex justify-content-center">
        <form class="card shadow p-5 w-100" style="margin-top: 5vh; margin-bottom: 5vh;" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off" enctype="multipart/form-data">
            <h2 class="mt-5 text-center">Welcome to Vienna largest pet portal!</h2>
            <p class="mt-3 text-center">Please, sign up to the system</p>
            <hr />
            <?php
            if (isset($errMSG)) {
            ?>
            ...
            <br>
            <div class="d-flex">
                <input class='form-control w-50' placeholder="Phone number" type="number" name="phone_number" value="<?php echo $phone_number ?>" />
            ...
            <br>
            <input type="text" name="address" class="form-control" placeholder="Address" maxlength="40" value="<?php echo $address ?>" />
            ...
            <hr />
            <button type="submit" class="btn btn-lg btn-primary" name="btn-signup">Sign Up</button>
            <hr />
